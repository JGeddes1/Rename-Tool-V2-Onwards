...
class MyApp:
    def __init__(self, parent):
        ...
        self.top_left_label = Button(self.top_left, bd=2, bg="red", text="Top Left", width=22, anchor=W)
        ...
        self.bottom_leftframe = Frame(self.bottom_frame, bd=2)
        self.bottom_leftframe.grid(row=0, column=2)

        self.text_box = Text(self.bottom_leftframe, width=40, height=5)
