...
c2 = Checkbutton(top_left, text="Scan subdirectories too", variable=var2).grid(
    column=2, row=0, padx=50, pady=5, sticky='nsew')

c3 = Checkbutton(top_left, text="Scan to Fix Folders in Directory", variable=var4).grid(
